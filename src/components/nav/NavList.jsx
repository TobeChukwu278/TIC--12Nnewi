...
const technologyProducts = [
    ...
    { id: 113, name: 'AI-Powered Security Camera', image: 'https://placehold.co/300x400/FF7F50/FFFFFF?text=AI+Camera', inStock: true, reviews: 4.7, price: 219.00, description: 'Smart detection and tracking to keep your home safe and secure.', category: 'IoT Devices' },
];
...
const TechnologyGadgetsPage = () => {
    ...
    // Use useMemo to optimize filtering and sorting, so it only recomputes when dependencies change.
    const filteredAndSortedProducts = useMemo(() => {
        return technologyProducts
            .filter(product => {
                // In Stock filter
                if (filters.inStock && !product.inStock) return false;
                // Price Range filter (assuming price range is not a UI element in this code)
    ...
    // Group the filtered and sorted products by category
