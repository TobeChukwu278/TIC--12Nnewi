...
// Placeholder data for Groceries products with updated data structure
const groceriesProducts = [
    { id: 67, name: 'Organic Bananas (1kg)', image: 'https://placehold.co/300x400/FFD700/000000?text=Bananas', inStock: true, reviews: 4.5, price: 2.50, description: 'Naturally sweet and organic bananas, perfect for a healthy snack or smoothies.', category: 'Fruits' },
    { id: 68, name: 'Fresh Farm Eggs (Dozen)', image: 'https://placehold.co/300x400/F0F8FF/000000?text=Eggs', inStock: true, reviews: 4.8, price: 4.50, description: 'A dozen fresh, free-range eggs from a local farm.', category: 'Dairy' },
    { id: 69, name: 'Whole Wheat Bread', image: 'https://placehold.co/300x400/D2B48C/000000?text=Bread', inStock: true, reviews: 4.2, price: 3.50, description: 'A loaf of nutritious whole wheat bread, baked fresh daily.', category: 'Bakery' },
    { id: 70, name: 'Premium Olive Oil (1L)', image: 'https://placehold.co/300x400/ADD8E6/000000?text=Olive+Oil', inStock: true, reviews: 4.9, price: 18.00, description: 'Cold-pressed extra virgin olive oil, perfect for cooking and salad dressings.', category: 'Pantry' },
    { id: 71, name: 'Assorted Fresh Vegetables', image: 'https://placehold.co/300x400/90EE90/000000?text=Vegetables', inStock: true, reviews: 4.7, price: 12.00, description: 'A selection of seasonal, fresh vegetables for a balanced meal.', category: 'Vegetables' },
    { id: 72, name: 'Ground Coffee (250g)', image: 'https://placehold.co/300x400/8B4513/FFFFFF?text=Coffee', inStock: false, reviews: 4.6, price: 8.50, description: 'Rich, aromatic ground coffee for a perfect brew every morning.', category: 'Beverages' },
    { id: 73, name: 'Dairy Milk (1 Gallon)', image: 'https://placehold.co/300x400/FFFFFF/000000?text=Milk', inStock: true, reviews: 4.3, price: 3.75, description: 'A gallon of fresh, wholesome dairy milk, a household staple.', category: 'Dairy' },
    { id: 74, name: 'Basmati Rice (5kg)', image: 'https://placehold.co/300x400/F5DEB3/000000?text=Rice', inStock: true, reviews: 4.8, price: 10.00, description: 'High-quality, long-grain Basmati rice, perfect for a variety of dishes.', category: 'Pantry' },
];
...
const GroceriesPage = () => {
    ...
    const filteredAndSortedProducts = groceriesProducts
        .filter(product => {
            // In Stock filter
    ...
    return (
        <div className="bg-gray-50 min-h-screen">
            {/* Hero Section */}
            <div className="relative bg-gradient-to-r from-yellow-500 via-lime-500 to-green-500 h-64 flex items-center justify-center text-white p-4">
                <div className="text-center">
                    <h1 className="text-5xl font-extrabold tracking-tight mb-2">Fresh Groceries</h1>
                    <p className="text-xl font-light opacity-80">Your daily essentials, delivered.</p>
                </div>
            </div>
            ...
            <div className="container mx-auto py-8 px-4">
                ...
                <div className="sticky top-0 bg-white rounded-xl shadow-lg z-10 p-4 mb-8 flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0 md:space-x-4">
                    <h2 className="text-xl font-semibold text-gray-800">Shop Fresh</h2>
